...
public class SosemanukEngine
     ...
     * Reset state.
     */
    private SosemanukEngine theResetState;
     ...
     */
    private SosemanukEngine(SosemanukEngine pSource) {
        reset(pSource);
    }
    ...
    @Override
    public SosemanukEngine copy() {
        return new SosemanukEngine(this);
    }

    @Override
    public void reset(final Memoable pState) {
        final SosemanukEngine e = (SosemanukEngine) pState;
        lfsr0 = e.lfsr0;
        lfsr1 = e.lfsr1;
        lfsr2 = e.lfsr2;
        lfsr3 = e.lfsr3;
