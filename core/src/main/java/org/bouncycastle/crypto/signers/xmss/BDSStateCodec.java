...
public final class BDSStateCodec
{
    ...
    public static byte[] encode(BDS state)
        throws IOException
    {
    ...
    public static byte[] encode(BDSStateMap stateMap)
        throws IOException
    {
        ByteArrayOutputStream byteOut = new ByteArrayOutputStream();
        DataOutputStream dataOut = new DataOutputStream(byteOut);
    ...
    public static BDS decodeBDS(byte[] encoding)
        throws IOException
    {
    ...
    public static BDSStateMap decodeBDSStateMap(byte[] encoding)
        throws IOException
    {
        checkEncodingSize(encoding);
        DataInputStream dataIn = new DataInputStream(new ByteArrayInputStream(encoding));
