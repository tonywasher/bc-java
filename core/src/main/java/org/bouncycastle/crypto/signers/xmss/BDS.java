    ...
    implements Serializable
{
     ...
     * <p>
     * The instance can be absent: {@code wotsPlus} is transient, so a state that arrived through
     * Java deserialization carries none until it is rebuilt around the digest its key names.
     * </p>
     */
    void clearSecrets()
    {
